...
export const Sidebar: React.FC = () => {
  ...
  const TABS = [
    ...
    // Magic Edit uses the specific config for icon, but we map it to a key for consistency
    { id: 'magic-edit', icon: uiConfig.magicEditIcon, label: 'Magic Edit', key: ICON_KEYS.SIDEBAR_MAGIC },
  ];
        ...
        <div className="p-4">
          ...
          {activeTab === 'text' && (
            <div className="space-y-3">
              ...
              >
                <Heading1 size={24} className="text-gray-800" />
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                {['abstract', 'nature', 'tech', 'people'].map((cat, i) => (
                  <button 
                    key={i}
                    onClick={() => addImage(`https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://placehold.co/400x400?text=${cat}`)}
                    className="aspect-square bg-gray-200 rounded overflow-hidden hover:opacity-80"
                  >
                    <img src={`https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://placehold.co/200x200?text=${cat}`} alt={cat} className="w-full h-full object-cover" />
                  </button>
                ))}
              </div>
            </div>
                ...
                <div className="space-y-3">
                    ...
                    <div className="relative">
                        <textarea 
                            ...
                            className="w-full p-2 text-sm border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 h-24 resize-none pr-8"
                        />
                        <button 
                            ...
                            title="Speak prompt"
                        >
                            {isListeningGen ? <Mic size={14} /> : <MicOff size={14} />}
                        </button>
                    </div>
                    <button 
                ...
                <div className="space-y-3">
                    ...
                    <div className="relative">
                        ...
                        <button 
                            ...
                            title="Speak prompt"
                        >
                            {isListeningVideo ? <Mic size={14} /> : <MicOff size={14} />}
                        </button>
                    </div>
                    ...
                    <>
                        <div className="relative">
                            ...
                            <button 
                                ...
                                title="Speak prompt"
                            >
                                {isListeningEdit ? <Mic size={14} /> : <MicOff size={14} />}
                            </button>
                        </div>
                        <button 
