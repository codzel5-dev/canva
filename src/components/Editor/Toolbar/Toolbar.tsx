          ...
          {isText && (
            <div className="flex items-center gap-2 animate-in fade-in slide-in-from-top-2 duration-200">
              ...
              <div className="flex items-center border border-gray-300 rounded overflow-hidden">
                 <button onClick={() => updateObject('fontSize', fontSize - 1)} className="w-8 h-9 hover:bg-gray-100 flex items-center justify-center border-r border-gray-300"><Minus size={12} /></button>
                 <input 
                    type="number" 
                    value={fontSize} 
                 ...
                 />
                 <button onClick={() => updateObject('fontSize', fontSize + 1)} className="w-8 h-9 hover:bg-gray-100 flex items-center justify-center border-l border-gray-300"><Plus size={12} /></button>
              </div>
